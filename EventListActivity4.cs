...
{
	[Activity(Label = "Meat")]
	public class EventListActivity4 : ListActivity
	{
		int _calId;
		RadioButton RadGood;
		RadioButton RadMed;
		...
		void InitAddEvent()
		{
			...
			addSampleEvent.Click += (sender, e) =>
			{
				...
				if (RadGood.Checked)
				{
					...
					eventValues.Put(CalendarContract.Events.InterfaceConsts.Title, "Feeling good haven't been eating Meat");
				...
				else if (RadMed.Checked)
				{
					ContentValues eventValues = new ContentValues();
					eventValues.Put(CalendarContract.Events.InterfaceConsts.CalendarId, _calId);
					eventValues.Put(CalendarContract.Events.InterfaceConsts.Title, "Feeling alright haven't been eating Meat");
					eventValues.Put(CalendarContract.Events.InterfaceConsts.Description, " ");
					eventValues.Put(CalendarContract.Events.InterfaceConsts.Dtstart, GetDateTimeMS(2011, 12, 15, 10, 0));
					eventValues.Put(CalendarContract.Events.InterfaceConsts.Dtend, GetDateTimeMS(2011, 12, 15, 11, 0));
				...
				else if (RadBad.Checked)
				{
					...
					ContentValues eventValues = new ContentValues();
					eventValues.Put(CalendarContract.Events.InterfaceConsts.CalendarId, _calId);
					eventValues.Put(CalendarContract.Events.InterfaceConsts.Title, "Feeling bad haven't been eating Meat");
					eventValues.Put(CalendarContract.Events.InterfaceConsts.Description, " ");
					eventValues.Put(CalendarContract.Events.InterfaceConsts.Dtstart, GetDateTimeMS(2011, 12, 15, 10, 0));
					eventValues.Put(CalendarContract.Events.InterfaceConsts.Dtend, GetDateTimeMS(2011, 12, 15, 11, 0));
