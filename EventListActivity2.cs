...
namespace Stop_It
{
	...
	public class EventListActivity2 : ListActivity
	{
		int _calId;
		RadioButton RadGood;
		RadioButton RadMed;
		...
		void InitAddEvent()
		{
			...
			addSampleEvent.Click += (sender, e) =>
			{
				...
				eventValues.Put(CalendarContract.Events.InterfaceConsts.Title, "Feeling good haven't been drinking Alcohol");
				eventValues.Put(CalendarContract.Events.InterfaceConsts.Description, Resource.Drawable.beer);
