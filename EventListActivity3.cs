...
namespace Stop_It
{
	[Activity(Label = "Dairy")]
	public class EventListActivity3 : ListActivity
	{
		int _calId;
		RadioButton RadGood;
		RadioButton RadMed;
		...
		void InitAddEvent()
		{
			...
			RadGood = FindViewById<RadioButton>(Resource.Id.radioButton1);
			RadMed = FindViewById<RadioButton>(Resource.Id.radioButton2);
			RadBad = FindViewById<RadioButton>(Resource.Id.radioButton3);
			...
			addSampleEvent.Click += (sender, e) =>
			{
				...
				if (RadGood.Checked)
				{
					...
					eventValues.Put(CalendarContract.Events.InterfaceConsts.Title, "Feeling good haven't been consuming Dairy");
					eventValues.Put(CalendarContract.Events.InterfaceConsts.Description, " ");
					eventValues.Put(CalendarContract.Events.InterfaceConsts.Dtstart, GetDateTimeMS(2016, 8, 13, 10, 0));
					eventValues.Put(CalendarContract.Events.InterfaceConsts.Dtend, GetDateTimeMS(2016, 8, 13, 11, 0));
				...
				else if (RadMed.Checked)
				{
					ContentValues eventValues = new ContentValues();
					eventValues.Put(CalendarContract.Events.InterfaceConsts.CalendarId, _calId);
					eventValues.Put(CalendarContract.Events.InterfaceConsts.Title, "Feeling alright haven't been consuming Dairy");
					eventValues.Put(CalendarContract.Events.InterfaceConsts.Description, " ");
					eventValues.Put(CalendarContract.Events.InterfaceConsts.Dtstart, GetDateTimeMS(2016, 8, 13, 10, 0));
					eventValues.Put(CalendarContract.Events.InterfaceConsts.Dtend, GetDateTimeMS(2016, 8, 13, 11, 0));
				...
				else if (RadBad.Checked)
				{

					ContentValues eventValues = new ContentValues();
					eventValues.Put(CalendarContract.Events.InterfaceConsts.CalendarId, _calId);
					eventValues.Put(CalendarContract.Events.InterfaceConsts.Title, "Feeling bad haven't been consuming Dairy");
					eventValues.Put(CalendarContract.Events.InterfaceConsts.Description, " ");
					eventValues.Put(CalendarContract.Events.InterfaceConsts.Dtstart, GetDateTimeMS(2016, 8, 13, 10, 0));
					eventValues.Put(CalendarContract.Events.InterfaceConsts.Dtend, GetDateTimeMS(2016, 8, 13, 11, 0));
